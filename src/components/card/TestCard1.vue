<template>
  <div class="card7">
    <div class="card7-theme1"> 
      <TestCard2 :background="Theme1.background">
        <template v-slot:title>
         <span> {{Theme1.title}} </span>
        </template>
        <template v-slot:content>
          <span> {{Theme1.content}} </span>
        </template>
    ...
    <div class="card7-theme2">
       <TestCard2 :background="Theme2.background">
        <template v-slot:title>
         <span> {{Theme2.title}} </span>
        </template>
        <template v-slot:content>
          <span> {{Theme2.content}} </span>
        </template>
        <template v-slot:playtime>
...
import TestCard2 from "@/components/card/TestCard2";

export default {
  name: '',
  components: { TestCard2 },
